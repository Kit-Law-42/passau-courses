...
class TestSQL2RA(unittest.TestCase):
    ...
    def test_select_star_from_person_where_age(self):
        self._check("select distinct * from Person where age=16",
    ...
    def test_select_name_from_person(self):
        self._check("select distinct name from Person",
                    "\project_{name}(Person);")

    def test_select_person_name_from_person(self):
        self._check("select distinct Person.name from Person",
                    "\project_{Person.name}(Person);")

    def test_select_name_age_from_person(self):
        self._check("select distinct name, age from Person",
    ...
    def test_select_star_from_person_eats(self):
        self._check("select distinct * from Person, Eats",
                    "Person \cross Eats;")

    def test_select_star_from_person_eats_serves(self):
        self._check("select distinct * from Person, Eats, Serves",
    ...
    def test_select_X_name_from_person_X(self):
        ...
        self._check("select distinct X.name from Person X",
